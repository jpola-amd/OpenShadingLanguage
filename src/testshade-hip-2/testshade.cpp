...
static bool use_optix            = OIIO::Strutil::stoi(
    OIIO::Sysutil::getenv("TESTSHADE_HIP"));
...
set_shadingsys_options()
{
    ...
    shadingsys->attribute("hip_no_inline", optix_no_inline);
    shadingsys->attribute("hip_no_inline_layer_funcs",
                          optix_no_inline_layer_funcs);
    shadingsys->attribute("hip_merge_layer_funcs",
                          !optix_no_merge_layer_funcs);
    shadingsys->attribute("hip_no_inline_rend_lib", optix_no_inline_rend_lib);
    shadingsys->attribute("hip_no_inline_thresh", optix_no_inline_thresh);
    shadingsys->attribute("hip_force_inline_thresh",
...
test_shade(int argc, const char* argv[])
{
    ...
    rend->attribute("hip_register_inline_funcs",
